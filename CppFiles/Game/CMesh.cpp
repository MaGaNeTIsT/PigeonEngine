...
CMesh::CMesh(const std::string& name, const std::vector<CustomStruct::CVertex3D>& vdata, const std::vector<UINT>& idata, Microsoft::WRL::ComPtr<ID3D11Buffer> vbuffer, Microsoft::WRL::ComPtr<ID3D11Buffer> ibuffer)
{
