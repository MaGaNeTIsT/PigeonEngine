...
namespace PigeonEngine
{
	...
	public:
		...
		void			SetupProxy(const BOOL32 InIsHidden, const BOOL32 InIsMovable, const BOOL32 InIsCastShadow, const BOOL32 InIsReceiveShadow, const ERenderPrimitiveMatrices& InMatrices, const EStaticMeshAsset* InMeshAsset, const EMaterialAsset* InMaterialAsset);
	public:
