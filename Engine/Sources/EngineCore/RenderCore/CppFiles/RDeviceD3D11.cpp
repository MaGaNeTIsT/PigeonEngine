...
void RDeviceD3D11::TranslateQueryDesc(D3D11_QUERY_DESC& output, const CustomStruct::CRenderQueryDesc& input)
{
...
void RDeviceD3D11::TranslateGetDataFlag(UINT& output, CustomStruct::CRenderAsyncGetDataFlag input)
{
...
void RDeviceD3D11::TranslateMapType(D3D11_MAP& output, CustomStruct::CRenderMapType input)
{
...
void RDeviceD3D11::TranslateMapFlag(UINT& output, CustomStruct::CRenderMapFlag input)
{
...
void RDeviceD3D11::TranslateInputLayoutDesc(D3D11_INPUT_ELEMENT_DESC& output, const CustomStruct::CRenderInputLayoutDesc& input)
{
...
D3D11_VIEWPORT RDeviceD3D11::GetViewport()
{
	return (RDeviceD3D11::m_RenderDevice->m_Viewport);
}
D3D_FEATURE_LEVEL RDeviceD3D11::GetFeatureLevel()
{
	return (RDeviceD3D11::m_RenderDevice->m_FeatureLevel);
}
Microsoft::WRL::ComPtr<ID3D11DeviceContext> RDeviceD3D11::GetRenderDeviceContext()
{
	return (RDeviceD3D11::m_RenderDevice->m_ImmediateContext);
}
Microsoft::WRL::ComPtr<ID3D11Device> RDeviceD3D11::GetRenderDevice()
{
	return (RDeviceD3D11::m_RenderDevice->m_Device);
}
