...
#include "../Shapes.h"
#include "../EngineCore/Core/Base/DataStructure/Text/Name.h"
...
public:
		...
		: CharacterBaseSettings(inSettings)
	{
		...
		CharacterName = EName(PE_TEXT("CharacterBase"));
	}
...
public:
	const EString& ToString() {return CharacterName.ToString();}

	const EString& ToString() const { return CharacterName.ToString(); }
