...
public:
	...
	UINT								MaxCollisionIterations = 5;								///< Max amount of collision loops
	UINT								MaxConstraintIterations = 15;							///< How often to try stepping in the constraint solving
	...
	UINT								MaxNumHits = 256;										///< Max num hits to collect in order to avoid excess of contact points collection
