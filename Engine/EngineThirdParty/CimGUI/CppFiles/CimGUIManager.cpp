...
#include "../../../Sources/EngineCore/Core/Headers/CEManager.h"
#include "../../../Sources/EngineCore/Base/Headers/CETimer.h"
...
#define DBT_DEVNODES_CHANGED    0x0007
    ...
    void CimGUIManager::Update()
    {
        ...
        io.DeltaTime = static_cast<FLOAT>(CEManager::GetGameTimer()->GetDeltaTime());
    ...
    void CimGUIManager::InitWnd()
    {
        ...
        HWND hWnd = CEManager::GetWindowHandle();
