...
#define ENGINE_SAMPLER_CLAMP_POINT_START_SLOT				(0u)
#define ENGINE_SAMPLER_CLAMP_LINEAR_START_SLOT				(1u)
#define ENGINE_SAMPLER_WRAP_POINT_START_SLOT				(2u)
#define ENGINE_SAMPLER_WRAP_LINEAR_START_SLOT				(3u)
